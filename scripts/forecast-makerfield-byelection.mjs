  ...
  const out = {
    ...
    inputs: {
      ...
      ward_count_discrepancy_note:
        "Our ward signal aggregates 9 Wigan wards inside Makerfield (post-2023 Wigan boundary review). Survation's note references 8 wards, the pre-2023 layout before Hindley split into Hindley + Hindley Green. Survation says Reform won 7 of 8; we observe Reform won all 9 on the new boundaries.",
